...
| 领域 | 总数 | 已读 | 在读 | 待读 |
|------|------|------|------|------|
| [NLP](papers/NLP/README.md) | 2 | 1 | 0 | 1 |
...
- [Attention Is All You Need](papers/NLP/2017_Unknown_Attention_Is_All_You_Need.md) — 完全抛弃 RNN/CNN，仅用自注意力机制构建序列模型，在机器翻译任务上超越此前所有方法，并成为现代
...
| 优先级 | 年份 | 标题 | 领域 | 加入原因 |
|--------|------|------|------|---------|
| 🟡 中 | 2026-05-14 | [论文笔记模板](papers/NLP/2017_Vaswani_Attention_Is_All_You_Need.md) | NLP | |
